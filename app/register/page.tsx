    ...
    <main className="min-h-screen text-white flex flex-col" style={{background: "var(--bg-main)", color: "var(--text-main)"}}>
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6 pt-32 pb-24">
        ...
        <div className="w-full max-w-md relative">
          ...
          <h1 style={{fontSize: "40px", fontWeight: "800", letterSpacing: "-1.5px", marginBottom: "8px", color: "var(--text-main)"}}>Claim your handle</h1>
          <p className="text-sm mb-10" style={{color: "var(--text-muted)"}}>This is your private identity on Shado. Choose wisely.</p>

          <div className="flex items-center rounded-xl px-5 py-4 mb-2 border transition" style={{
            background: "var(--bg-card)", borderColor: focused ? "#FF6B00" : "rgba(128,128,128,0.15)"
          }}>
          ...
          <p className="text-xs mb-8 ml-1" style={{color: "var(--text-muted)", opacity: 0.5}}>Only letters, numbers and underscores. Min 3 characters.</p>

          <div className="rounded-2xl p-5 mb-6 border" style={{background: "var(--bg-card)", borderColor: "rgba(128,128,128,0.1)"}}>
            {[
